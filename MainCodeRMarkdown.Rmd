...
author: "Kashish Rai, Karin Funaki, Chenzi Xiu, Eric -- "
...
#Question: Does family income affect the average educational progress and its related variables (Hours_Studied, Tutoring Sessions)?
...
**Looking at our integer variables of interest here, it looks like an average amount of all surveyed students study for about 19.9 hours and have 1.5 tutoring sessions. This value does not change much when observing the median and mode: with study hours being around 20 hours for both and tutoring sessions being 1. This tells that most students study around those averages. Looking through the frequency distribution data, it looks like most students study in the data set study between 11-30 hours. It also looks like most students get between 0-2 tutoring sessions, with a smaller range being from 3-5.**
...
independent_vars <- c("Family_Income", "Extracurricular_Activities", "Parental_Involvement")
...
for (var in independent_vars) {
  ...
  anova_model <- aov(formula, data = studentperformance)
  
  print(summary(anova_model))
  
  cat("Post-hoc results for:", var, "\n")
  ...
  # QQ plot
  qqnorm(resid(anova_model), main = paste("QQ Plot for", var))
  qqline(resid(anova_model), col = "red", lwd = 2)
  
  # Reset graphics
  par(mfrow = c(1, 1))
  
  # Create a boxplot for visualization
  boxplot(formula, data = studentperformance,
...
Post-hoc for Parental Involvement and Progress 
